...
import { FileUp, Search, Calendar, ChevronRight, Award, Trash2, Filter } from "lucide-react";
...
const initialMockTests: MockTest[] = [
  {
    id: "test-8",
    title: "NEET Full Syllabus Mock 08",
    date: "2026-06-08",
    questionsCount: 180,
    score: 645,
    maxMarks: 720,
    status: "analyzed",
    subjectAccuracy: { Physics: 82, Chemistry: 88, Biology: 94 }
  },
  {
    id: "test-7",
    title: "NEET Full Syllabus Mock 07",
    date: "2026-06-01",
    questionsCount: 180,
    score: 615,
    maxMarks: 720,
    status: "analyzed",
    subjectAccuracy: { Physics: 76, Chemistry: 84, Biology: 90 }
  },
  {
    id: "test-6",
    title: "NEET Physics Mechanics Sectional",
    date: "2026-05-24",
    questionsCount: 45,
    score: 145,
    maxMarks: 180,
    status: "analyzed",
    subjectAccuracy: { Physics: 80, Chemistry: 0, Biology: 0 }
  },
  {
    id: "test-5",
    title: "NEET Chemistry Organic Sectional",
    date: "2026-05-18",
    questionsCount: 45,
    score: 152,
    maxMarks: 180,
    status: "analyzed",
    subjectAccuracy: { Physics: 0, Chemistry: 84, Biology: 0 }
  },
  {
    id: "test-4",
    title: "NEET Full Syllabus Mock 06",
    date: "2026-05-15",
    questionsCount: 180,
    score: 585,
    maxMarks: 720,
    status: "analyzed",
    subjectAccuracy: { Physics: 68, Chemistry: 78, Biology: 88 }
  },
  {
    id: "test-3",
    title: "NEET Biology Genetics Test",
    date: "2026-05-09",
    questionsCount: 90,
    score: 320,
    maxMarks: 360,
    status: "analyzed",
    subjectAccuracy: { Physics: 0, Chemistry: 0, Biology: 88 }
  },
  {
    id: "test-2",
    title: "NEET Chemistry Physical Chemistry Mock",
    date: "2026-06-09",
    questionsCount: 45,
    score: null,
    maxMarks: 180,
  ...
  {
    id: "test-1",
    title: "NEET Physics Thermodynamics Mock",
    date: "2026-06-09",
    questionsCount: 45,
    score: null,
    maxMarks: 180,
